...
public class ActionsPractices {
    ...
    */
    ...
    public void hover_over_test(){
        ...
        //#1 - Create the instance of action class, And pass the driver instance the constructor
        ...
        Assert.assertTrue(user3.isDisplayed(),"Image 32 is Not displayed! Verification failed!!!");
